...
if [ -x /usr/bin/dircolors ]; then
    test -r /Users/DEZ01/.dircolors && eval "$(dircolors -b /Users/DEZ01/.dircolors)" || eval "$(dircolors -b)"
...
[ -f /Users/DEZ01/.fzf.zsh ] && source /Users/DEZ01/.fzf.zsh

# Enable Powerlevel10k instant prompt. Should stay close to the top of /Users/DEZ01/.zshrc.
# Initialization code that may require console input (password prompts, [y/n]
# confirmations, etc.) must go above this block; everything else may go below.
if [[ -r "${XDG_CACHE_HOME:-/Users/DEZ01/.cache}/p10k-instant-prompt-${(%):-%n}.zsh" ]]; then
  source "${XDG_CACHE_HOME:-/Users/DEZ01/.cache}/p10k-instant-prompt-${(%):-%n}.zsh"
fi

# To customize prompt, run `p10k configure` or edit /Users/DEZ01/.p10k.zsh.
[[ ! -f /Users/DEZ01/.p10k.zsh ]] || source /Users/DEZ01/.p10k.zsh
...
alias connect='ssh -p 28 -X dinaka@11.187.134.21' #needs modificatin to be accurate
alias ll='ls -alF'
alias la='ls -A'
alias l='ls -CF'
...
alias update='source /Users/DEZ01/.bashrc'
